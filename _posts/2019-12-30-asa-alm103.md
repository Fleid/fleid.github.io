...
$script = "$ENV:BUILD_SOURCESDIRECTORY\ASATest1\ASATest1.asaql"
...
$parametersData | ConvertTo-Json | Out-File $output"\ASATest1.JobTemplate.parameters.validation.json"
...
$testResult = Test-AzResourceGroupDeployment `
  ...
  -TemplateParameterFile $output"\ASATest1.JobTemplate.parameters.validation.json" `
  -Mode Incremental
