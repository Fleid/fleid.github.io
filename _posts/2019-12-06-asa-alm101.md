...
- The data pipeline itself, with live input/outputs - including using Cosmos DB to debug a live stream
...
![Schema](https://github.com/Fleid/fleid.github.io/blob/master/_posts/201912_asa_alm101/asa_almASAextension.png?raw=true)
