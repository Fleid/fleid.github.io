...
> **Update** : I researched the topic a bit more since then, and [shared my findings](https://www.eiden.ca/devops-keyvault-powershell/) for those interested. The short version is that the approach I take below is quite acceptable
